        ...
        <v-row class="mx-5">
          <v-col>
            ...
            <v-card class="mt-7" hover> <v-card-item>  <template v-slot:prepend>
              ...
              <v-card-text>此版本开源于 <a href="https://github.com/sunwuyuan/AutoScratchDesktopMirror">GitHub</a>
                <br />
                任何问题欢迎加QQ群沟通 964979747<br />

                <p class="font-weight-light mt-2 text-caption">
                  此站点目前由 <a href="https://wuyuan.dev">孙悟元</a>(<a href="https://zerocat.wuyuan.dev">ZeroCat社区</a>)
                  维护。<br />

                  感谢: Scratch Team, GitHub, Vue.js, Vuetify.js, scratch-bar, waterblock79 , wrj2009 以及所有为这个项目添砖加瓦的人们!
                </p>
              </v-card-text></v-card>
            ...
            <v-card elevation="2" class="mt-7"  hover>
              ...
              <v-card-text>
                ...
                <v-select v-model="download_source" :hint="`${download_source.state}, ${download_source.abbr}`"
                  :items="download_source_list" item-title="state" item-value="abbr" label="Select" persistent-hint
